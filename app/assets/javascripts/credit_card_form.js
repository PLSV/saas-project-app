...
function GetURLParameter(sParam) {
	...
	for(var i=0; i<sURLVariable.length; i++) {
		var sParameter = sURLVariable[i].split('=');
...
$(document).ready(function() {
	...
	//function to show errors when Stripe functionality return as error
	show_error = function(message) {
		if($("#flash-messages").size() < 1) {
			$('div.container.main div:first').prepend("<div id='flask-messages'></div>")
		}
